...
def download_image(url: str, filename: str):
    ...
    try:
        ...
        logger.error(f"Could not download image {filename}. An invalid URL was provided. {e}.")
        return 
    ...
    if r.status_code == 200:
        ...
        logger.error(f"Could not download image {filename}. Received {r.status_code} status code.")
